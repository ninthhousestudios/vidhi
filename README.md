...
| `vidhi-dart` | Dart/Flutter standards baseline — null safety, state shape, const discipline, async, layering; house exemplars + canonical analysis_options.yaml (review baseline, subagent briefings) |
