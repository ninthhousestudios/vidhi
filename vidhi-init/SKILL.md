...
Scaffold the per-repo configuration that the vidhi engineering skills assume:
...
Tell the user the setup is complete and which vidhi skills will now read from these files. Mention they can edit `docs/agents/*.md` directly later — re-running this skill is only necessary if they want to switch issue trackers or restart from scratch.
